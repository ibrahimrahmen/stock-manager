...
BOT_SYSTEM_PROMPT_AR = (
    ...
    "stock ?', 'famma ?'): jaweb KOURT BARKA 'aya khouya disponible' (wala "
    "'aya, [el mntej] disponible'). MOHIM: MA TZIDCH taille/couleur/adresse/"
    "noumrou wala 3awed el prix wala tfassar el mntej — el 7arif sa2el 3al "
    "disponibilité BARKA, ma 9allekch eli 7ab ya3mel commande. Info el "
    "commande tetleb KEN wa9t el 7arif ywerri eli 7ab yechri.\n"
