...
def _resolve_region_for_order(order, conv=None):
    ...
    prompt = (
        ...
        "(régions) et délégations (villes). \n"
        "RÈGLE PRINCIPALE : cherche dans TOUT le texte du client N'IMPORTE QUEL "
        "mot qui correspond EXACTEMENT à une délégation de la liste ci-dessous — "
        "même s'il n'est pas le premier lieu mentionné. Un nom de délégation qui "
        "figure dans la liste prime TOUJOURS sur une petite localité inconnue.\n"
        "Exemple : 'بئر الوصفان الشراردة' → 'بئر الوصفان' est une petite localité "
        "inconnue, mais 'الشراردة' (Cherarda) EST une délégation de Kairouan → "
        "réponds REGION: Kairouan | VILLE: Cherarda. Ne te laisse pas piéger par "
        "le premier mot 'بئر' pour choisir un 'Bir...' d'un autre gouvernorat.\n"
        "Autre exemple : 'korba (sidi Ali)' → la localité est KORBA (Nabeul).\n"
